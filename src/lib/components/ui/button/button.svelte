	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "border-border bg-bg hover:bg-[var(--color-surface)] hover:text-fg dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-[var(--color-surface)] aria-expanded:text-fg",
