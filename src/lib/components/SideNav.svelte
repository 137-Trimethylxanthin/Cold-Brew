...
>
	...
	<div class="grid gap-2 content-start">
		<button
			onclick={() => goto('/')}
			class="flex items-center justify-start gap-[9px] min-h-[42px] px-3 text-soft text-left hover:bg-brand/10 hover:text-fg focus-visible:bg-brand/10 focus-visible:text-fg"
		>
	...
	<section class="min-w-0 border border-outline rounded-3xl p-4 bg-surface-2/56">
		<p class="m-0 mb-2 text-brand font-mono text-[0.68rem] tracking-widest uppercase">Output</p>
